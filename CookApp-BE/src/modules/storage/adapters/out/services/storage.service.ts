...
import { addFilePrefix } from "utils";
...
export class StorageService implements IStorageService {
  ...
  async getSignedLink(fileName: string, userId: string): Promise<PreSignedLinkResponse> {
  ...
  async getSignedLinks(fileNames: string[], userId: string): Promise<PreSignedLinkResponse[]> {
