...
export class addShareFoodType1651487449736 implements MigrationInterface {
    name = 'addShareFoodType1651487449736'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."posts_kind_enum" RENAME TO "posts_kind_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."posts_kind_enum" AS ENUM('MOMENT', 'FOOD_SHARE')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."posts_kind_enum_old" AS ENUM('MOMENT')`);
